# Generated by Django 3.1.2 on 2021-03-05 11:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('child_management', '0013_auto_20210223_1035'),
    ]
    ...
    operations = [
         ...
         migrations.RunSQL("""create or replace view dash_child_days_lastvisit_view as 
            ...
            inner join child_management_childshelterhomerelation csr on csr.shelter_home_id = sh.id and csr.active = 2
            inner join child_management_child cc on cc.id = csr.child_id and cc.active = 2
            left outer join (
        ...
        migrations.RunSQL("""create or replace view dash_recommended_adoption_view as 
            ...
            left outer join (
                ...
                where active = 2
            ) as cfh on cfh.child_id = cc.id and cfh.flagged_status = 2"""
        ),
        migrations.RunSQL("""create or replace view dash_child_cci_category as 
            ...
            sum(case when cc.childclassification_id = 2 then cc.child_clasification_count else 0 end) as abandoned_count,
            sum(case when cc.childclassification_id = 3 then cc.child_clasification_count else 0 end) as fam_not_trace_count,
            sum(case when cc.childclassification_id = 4 then cc.child_clasification_count else 0 end) as surrendered_count,
            sum(case when cc.childclassification_id = 5 then cc.child_clasification_count else 0 end) as was_trafficked_count,
            sum(case when cc.childclassification_id = 6 then cc.child_clasification_count else 0 end) as orp_no_guardian_count,
            sum(case when cc.childclassification_id = 7 then cc.child_clasification_count else 0 end) as orp_fit_guardian_count,
            sum(case when cc.childclassification_id = 8 then cc.child_clasification_count else 0 end) as unfit_guardian_poverty_count,
            sum(case when cc.childclassification_id = 9 then cc.child_clasification_count else 0 end) as unfit_guardian_addict_count,
            sum(case when cc.childclassification_id = 10 then cc.child_clasification_count else 0 end) as unfit_guardian_abuse_count,
            sum(case when cc.childclassification_id = 11 then cc.child_clasification_count else 0 end) as unfit_guardian_criminal_count,
            sum(case when cc.childclassification_id = 12 then cc.child_clasification_count else 0 end) as unfit_guardian_unsound_count,
            sum(case when cc.childclassification_id = 13 then cc.child_clasification_count else 0 end) as unfit_guardian_needcare_count,
            sum(case when cc.childclassification_id = 14 then cc.child_clasification_count else 0 end) as unfit_guardian_unwilling_count,
            sum(case when cc.childclassification_id = 15 then cc.child_clasification_count else 0 end) as fit_parent_count,
            sum(case when cc.childclassification_id = 16 then cc.child_clasification_count else 0 end) as unfit_parent_poverty_count,
            sum(case when cc.childclassification_id = 17 then cc.child_clasification_count else 0 end) as unfit_parent_single_count,
            sum(case when cc.childclassification_id = 18 then cc.child_clasification_count else 0 end) as unfit_parent_addict_count,
            sum(case when cc.childclassification_id = 19 then cc.child_clasification_count else 0 end) as unfit_parent_abuse_count,
            sum(case when cc.childclassification_id = 20 then cc.child_clasification_count else 0 end) as unfit_parent_criminal_count,
            sum(case when cc.childclassification_id = 21 then cc.child_clasification_count else 0 end) as unfit_parent_unsound_count,
            sum(case when cc.childclassification_id = 22 then cc.child_clasification_count else 0 end) as unfit_parent_needcare_count,
            sum(case when cc.childclassification_id = 23 then cc.child_clasification_count else 0 end) as unfit_parent_unwilling_count
            from master_data_shelterhome sh
            inner join master_data_district mdd on sh.district_id = mdd.id and sh.active = 2 
            inner join master_data_state mds on mdd.state_id = mds.id
            left outer join ( 
                ...
                inner join child_management_child ch on ch.id = ccc.child_id and ch.active = 2 
        ...
        migrations.RunSQL("""create or replace view dash_child_cci_stay_view as 
            ...
            inner join (
                ...
                where active = 2 
            ) csr on csr.shelter_home_id = sh.id
            inner join child_management_child cc on cc.id = csr.child_id and cc.active = 2"""
        ),
        ...
        migrations.RunSQL("""create or replace view rep_child_details_view as 
            ...
            left outer join child_management_guardian as cg on ch.id = cg.child_id and cg.active = 2
            left outer join (
